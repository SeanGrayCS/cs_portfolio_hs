...
public class HistogramRunner
{
	...
	{
		Histogram hist = new Histogram("1 5 3 4 5 5 5 4 3 2 5 5 5 3", 8); //creates Histogram
		//print Histogram, changes values, then prints again
		...
		System.out.println("");
		hist.reset("1 1 1 -91 1 1 1 5 3 3 3 99 5 5 3", 6); //resets Histogram
		System.out.println(hist);
