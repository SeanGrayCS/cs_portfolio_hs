/**
 * OddToEvenRunner.java 02/05/2020
 *
 * @author - Sean Gray
 * @author - Period 1
 * @author - Id 902073
...
public class OddToEvenRunner
{
	...
	{
		ListOddToEven s = new ListOddToEven(); //create ListOddToEven
		System.out.println(s.go(Arrays.asList(7, 1, 5, 3, 11, 5, 6, 7, 8, 9, 10, 12345, 11))); //test values
		...
		System.out.println(s.go(Arrays.asList(2, 3, 11, 21, 5, 7)));
